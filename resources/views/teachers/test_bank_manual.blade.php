								...
								<div class="uk-width-medium-1-1">
									...
									<ul id="switcher-content" class="uk-switcher">
										<li aria-hidden="true">
												...
												<div class="uk-width-medium-1-1">
													...
													<form class="uk-form">
														...
														<ul class="uk-subnav uk-subnav-pill">
															<li class="uk-active"><a href="">單選題</a></li>
															<li><a href="">複選題</a></li>
															<li><a href="">填充題</a></li>
															<li><a href="">選填題</a></li>
														</ul>
											...
											<div class="uk-grid" data-uk-grid-margin="">
												<div class="uk-width-medium-1-1">
													<button onclick="window.location.href='lesson_list.2.html'" class="uk-button uk-button-primary uk-button-large" type="button" data-uk-button disabled>手動出題</button>
													 <p class="uk-text-bold">勾選題目加入教材：</p>
													<div class="uk-panel">
														<div class="uk-panel uk-panel-box">
															<ul class="uk-nav uk-nav-parent-icon">
																...
																<hr class="uk-grid-divider">
																<li class="uk-parent">
																	<input type="checkbox"> <img src="{!! asset('img/quiz/04.png') !!}">
																</li>
																<hr class="uk-grid-divider">
																<li class="uk-parent">
																	<input type="checkbox"> <img src="{!! asset('img/quiz/05.png') !!}">
																</li>
															</ul>
														</div>
													</div>
